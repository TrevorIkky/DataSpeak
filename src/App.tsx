...
function App() {
  ...
  return (
    <ThemeProvider defaultTheme="system" storageKey="dataspeak-theme">
      <TooltipProvider>
        <div className="flex h-screen w-screen flex-col bg-background safe-area-top safe-area-bottom">
          {/* Header */}
          <header className="flex items-center justify-between border-b px-4 py-3 bg-card safe-area-x">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="flex md:hidden">
                <Sheet open={mobileConnectionsOpen} onOpenChange={setMobileConnectionsOpen}>
                  ...
                  <SheetContent side="left" className="w-80 !p-0 flex flex-col">
                    <SheetHeader className="p-4 border-b shrink-0 pt-[max(1rem,env(safe-area-inset-top))] pl-[max(1rem,env(safe-area-inset-left))]">
                      <SheetTitle>Database Navigator</SheetTitle>
                      <SheetDescription>
                        Browse your database connections and tables
                      </SheetDescription>
                    </SheetHeader>
                    <div className="flex-1 overflow-hidden pl-[env(safe-area-inset-left)]">
                      <DatabaseNavigator />
                    </div>
                  </SheetContent>
                </Sheet>
              ...
              <img src="/logo.png" alt="DataSpeak" className="h-6 w-6" />
